# Cybersecurity Lab Portfolio - Evidence and Analysis Log

**Portfolio Date**: May 2026 | **Author**:  | **Last Updated**: 2026-05-25
...
*Caption: Final corporate mapping tracking stakeholders (Marc Clotet, Aina Clotet, Marta Baldo, Jan Andreu) and regional offices (Barcelona, Sweden) up to the recent May 2026 Cannes Film Festival releases.*
...
*Caption: Expanding the scan scope to all 65535 ports increased processing duration to 17:41 but successfully uncovered 1 additional Critical vulnerability and 1 additional Medium vulnerability, raising the total threat footprint to 71 vulnerabilities.*
